...
```{r}
LostArkData <- read.csv("D:\\GradSchool\\STA 566\\Data\\NAwest Mkt sept 12.csv")
...
I: Hyper express mission with a new character have been confirmed on this date, meaning you can now level a single character to a high level. 
